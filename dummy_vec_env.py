...
class DummyVecEnv(VecEnv):
    ...
    def __init__(self, env_fns: List[Callable[[], gym.Env]]):
        ...
        self.buf_rews = [None]*self.num_envs
    ...
    def step_wait(self) -> VecEnvStepReturn:
        ...
        return (deepcopy(obs), self.buf_rews.copy(), np.copy(self.buf_dones), deepcopy(self.buf_infos))
        #return (self._obs_from_buf(), self.buf_rews.copy(), np.copy(self.buf_dones), deepcopy(self.buf_infos))
